...
`xlsx-extract-images` runs entirely in your browser. There is no server component and no
...
- The workbook image-extraction pipeline, the service worker, and the PWA manifest.
