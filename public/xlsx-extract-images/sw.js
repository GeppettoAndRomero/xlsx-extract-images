...
const CACHE_NAME = 'xlsx-extract-images-v1';
const RUNTIME_CACHE = 'xlsx-extract-images-runtime';

// キャッシュするリソース（静的アセット）
const PRECACHE_URLS = [
  '/xlsx-extract-images/',
  '/xlsx-extract-images/manifest.json',
  '/xlsx-extract-images/icon-192.png',
  '/xlsx-extract-images/icon-512.png',
];
...
function isStaticAsset(pathname) {
  ...
  return staticExtensions.some(ext => pathname.endsWith(ext)) || pathname === '/xlsx-extract-images/manifest.json';
}
